...
def make_parser():
    ...
    parser.add_argument(
        "-f", "--exp_file",
        default="/home/ylp/wlh/paper/dptrack/exps/example/mot/yolox_x_ablation_dp_track_reid.py",
        type=str,
    ...
    parser.add_argument("--test", dest="test", default=True, action="store_true", help="Evaluating on test-dev set.",)
    ...
    parser.add_argument( "--path", default="/home/ylp/wlh/paper/dptrack/videos/demo1", help="path to images or video")
