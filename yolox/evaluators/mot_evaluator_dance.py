...
from trackers.dp_tracker.dp_track_reid import DP_Track_ReID
    ...
    def evaluate_dp_track_reid(
        ...
        for cur_iter, (imgs, _, info_imgs, ids, raw_image) in enumerate(    # [hgx0411] add raw_image for FastReID
            ...
            with torch.no_grad():
                ...
                if frame_id == 1:
                    tracker = DP_Track_ReID(args, det_thresh=self.args.track_thresh, iou_threshold=self.args.iou_thresh,
