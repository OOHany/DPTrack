...
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT) ![test](https://img.shields.io/static/v1?label=By&message=Pytorch&color=red) [![DOI](https://zenodo.org/badge/885276582.svg)](https://doi.org/10.5281/zenodo.14057238)
...
```
# DPTrack
python tools/run_dptrack_dance.py -f exps/example/mot/yolox_dancetrack_val_dp_track_reid.py -b 1 -d 1 --fp16 --fuse --expn $exp_name
```
...
```
# DPTrack
python tools/run_dptrack_dance.py --test -f exps/example/mot/yolox_dancetrack_test_dp_track_reid.py -b 1 -d 1 --fp16 --fuse --expn $exp_name
```
...
```
#DPTrack
python tools/run_dptrack_dance.py -f exps/example/mot/yolox_x_mix_mot20_ch_dp_track_reid.py -b 1 -d 1 --fuse --mot20 --expn $exp_name
```
...
```
# DPTrack
python3 tools/run_dptrack_dance.py -f exps/example/mot/yolox_x_ablation_dp_track_reid.py -b 1 -d 1 --fuse --expn  $exp_name 
```
...
```
python3 tools/demo_track.py --demo_type image -f exps/example/mot/yolox_dancetrack_val_dp_track_reid.py -c pretrained/ocsort_dance_model.pth.tar --path ./datasets/dancetrack/val/dancetrack0079/img1 --fp16 --fuse --save_result
```

<img src="images/demo.GIF" alt="demo" style="zoom:34%;" />
