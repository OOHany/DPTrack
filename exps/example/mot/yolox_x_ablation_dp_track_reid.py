...
class Exp(MyExp):
    def __init__(self):
        ...
        self.ckpt = "/home/ylp/wlh/paper/dptrack/pretrained/ocsort_mot17_ablation.pth.tar"
        self.use_byte = True
        self.dataset = "mot17"
        self.inertia = 0.05
        ...
        self.fast_reid_config = "/home/ylp/wlh/paper/dptrack/fast_reid/configs/MOT17/sbs_S50.yml"
        self.fast_reid_weights = "/home/ylp/wlh/paper/dptrack/pretrained/mot17_sbs_S50.pth"
