...
class Exp(MyExp):
    def __init__(self):
        ...
        self.ckpt = "/home/ylp/wlh/paper/dptrack/pretrained/bytetrack_dance_model.pth.tar"  # 对应修改
        self.use_byte = True
        ...
        self.fast_reid_config = "/home/ylp/wlh/paper/dptrack/fast_reid/configs/CUHKSYSU_DanceTrack/sbs_S50.yml"  # 对应修改
        self.fast_reid_weights = "/home/ylp/wlh/paper/dptrack/pretrained/dancetrack_sbs_S50.pth"  # 对应修改
