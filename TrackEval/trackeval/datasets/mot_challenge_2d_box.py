...
class MotChallenge2DBox(_BaseDataset):
    ...
    def get_default_dataset_config():
        ...
        default_config = {
            ...
            'GT_FOLDER': '/home/ylp/wlh/paper/HybridSORT-level-cue-search-dancetrack/datasets/dancetrack/val',  # Location of GT data
            # 'TRACKERS_FOLDER': os.path.join(code_path, 'data/trackers/mot_challenge/'),  # Trackers location
            'TRACKERS_FOLDER': '/home/ylp/wlh/paper/HybridSORT-level-cue-search-dancetrack/output/dancetrack/val',  # Trackers location
            'OUTPUT_FOLDER': None,  # Where to save eval results (if None, same as TRACKERS_FOLDER)
            # 'TRACKERS_TO_EVAL': None,  # Filenames of trackers to eval (if None, all in folder)
            'TRACKERS_TO_EVAL': ['val'],  # Filenames of trackers to eval (if None, all in folder)
            ...
            'SEQMAP_FILE': '/home/ylp/wlh/paper/HybridSORT-level-cue-search-dancetrack/datasets/dancetrack/val/val_seqmap.txt',  # Directly specify seqmap file (if none use seqmap_folder/benchmark-split_to_eval)
    ...
    def __init__(self, config=None):
        ...
        self.gt_fol = copy.deepcopy(self.config['GT_FOLDER'])
